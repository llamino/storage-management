...
connect(
    db='warehouse_management',   # نام دیتابیس MongoDB
...
SECRET_KEY = 'django-insecure--jl(&(o$9r8+r*juniq8fb7wm(d18moo_=yevc#*7v4wi-l@k0'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'warehouse_management_service']
